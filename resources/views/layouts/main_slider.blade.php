			...
			<ul>	<!-- SLIDE  -->
				...
				data-description="">
					...
					<a  href="/Compras"
						...
						style="z-index: 5; font-size: 22px; line-height: 50px; font-weight: 400; color: rgba(255,255,255,1); letter-spacing: 2px;font-family:Roboto Condensed;border-color:rgb(255,255,255);border-style:solid;border-width:1px 1px 1px 1px;outline:none;box-shadow:none;cursor:pointer;text-align:center">Compra</a>
					...
					<div class="tp-caption   tp-resizeme"
						...
						style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Abre tu tienda en linea. </div>
				</li>
				<!-- SLIDE  -->
				<li data-index="rs-74"
					data-transition="fade"
					...
					<a
						...
						style="z-index: 6; white-space: normal; font-size: 22px; line-height: 50px; font-weight: 400; color: rgba(255,255,255,1); letter-spacing: 2px;font-family:Roboto Condensed;border-color:rgb(255,255,255);border-style:solid;border-width:1px 1px 1px 1px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">Compra</a>
					...
					<div class="tp-caption   tp-resizeme"
						...
						style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Encuentra lo indispensable.
					</div>
				</li>
				<!-- SLIDE  -->
				<li data-index="rs-75"
					...
					data-easeout="default"
					data-masterspeed="300"
					data-thumb="images/slider/slider-2.pn"
					data-rotate="0"
					data-saveperformance="off"
					data-title="Slide"
					data-param1=""
